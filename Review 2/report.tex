...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\linewidth]{AWF.png}
\caption{Adaptive Workflow Framework (AWF) illustrating the CUSUM-triggered drift adaptation logic within the federated hierarchy.}
\end{figure}
...
\begin{itemize}[noitemsep]
\item \textbf{Domain Focus:} Smart Grid Analytics via Pecan Street Dataset.
\item \textbf{Version Control:} Repository active at \texttt{github.com/aksharsakhi/23CSE399-Project-Phase-1}.
\item \textbf{Mathematical Model:} CUSUM logic integration completed.
\item \textbf{Baselines:} Comparative study of FedAvg vs. FedPer initialized.
\end{itemize}
